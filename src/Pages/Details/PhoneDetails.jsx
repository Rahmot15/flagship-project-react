...
const PhoneDetails = () => {
  ...
  const { brand, name, model, image, description, camera_info } =
    singlePhone || {};
  ...
  return (
    <div className="w-11/12 mx-auto space-y-3">
      ...
      <p className="text-xl">
        <span className="text-2xl text-amber-500 mr-5">Brand :</span> {brand}
      </p>
      <p className="text-xl">
        <span className="text-2xl text-amber-500 mr-5">Model :</span> {model}
      </p>
      <p className="text-xl">
        <span className="text-2xl text-amber-500 mr-5">Description :</span>{" "}
        {description}
      </p>
      <p className="text-xl">
        <span className="text-2xl text-amber-500 mr-5">Camera_info :</span>{" "}
        {camera_info}
      </p>
    </div>
  );
